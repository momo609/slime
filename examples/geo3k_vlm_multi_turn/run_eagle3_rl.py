...
DATA_ROOT = "/home/wxx/geo3k_imgurl_processed/"
...
def execute():
    ...
    sglang_args = (
        ...
        "--sglang-speculative-draft-model-path /home/wxx/Qwen3-VL-8B-Instruct-eagle3 "
    )
    ...
    eagle3_args = (
        ...
        "--eagle3-training-interval-steps 5 "
        "--eagle3-batch-size-per-gpu 2 "
        "--eagle3-max-seq-len 8192 "
        "--eagle3-max-epochs 10 "
        "--eagle3-checkpoint-path /home/wxx/qwen3-eagle "
