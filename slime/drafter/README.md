...
- 鉁?**Online Training**: Train Eagle3 drafter model asynchronously during RL training
- 鉁?**Real-time Updates**: Sync trained weights to SGLang inference engine
- 鉁?**Cross-step Data Accumulation**: Collect and use data from multiple RL steps
- 鉁?**Memory Efficient**: Support CPU offloading for model and optimizer
- 鉁?**Flexible Configuration**: Extensive command-line arguments for customization
- 鉁?**Monitoring**: Built-in logging and metrics for training progress
...
鈹溾攢鈹€ drafter/
鈹?  鈹溾攢鈹€ __init__.py
鈹?  鈹溾攢鈹€ eagle3_trainer.py          # Background trainer
鈹?  鈹溾攢鈹€ eagle3_weight_updater.py   # Weight updates
鈹?  鈹溾攢鈹€ eagle3_config.py           # Configuration
鈹?  鈹溾攢鈹€ README.md                  # This file
鈹?  鈹斺攢鈹€ models/
鈹?      鈹溾攢鈹€ __init__.py
鈹?      鈹斺攢鈹€ qwen2_eagle3.py        # Qwen2 Eagle3 model
鈹溾攢鈹€ backends/
鈹?  鈹斺攢鈹€ megatron_utils/
鈹?      鈹溾攢鈹€ eagle3_integration.py  # Integration layer
鈹?      鈹斺攢鈹€ eagle3_actor_patch.py  # Training loop patches
鈹斺攢鈹€ examples/
    鈹斺攢鈹€ eagle3_integration/
        鈹斺攢鈹€ run_eagle3_rl.py       # Training example
```
