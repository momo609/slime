...
try:
    from slime.backends.sglang_utils.slime_sglang_patch import install_slime_sglang_patches
    install_slime_sglang_patches()
except Exception as _e:
    logger.debug("Failed to install slime SGLang patches: %s", _e)
